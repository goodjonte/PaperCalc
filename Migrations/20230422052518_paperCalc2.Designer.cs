...
namespace PaperCalc.Migrations
{
    ...
    [Migration("20230422052518_paperCalc2")]
    partial class paperCalc2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaperCalc.Models.GSM", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PaperCalc.Models.Paper", b =>
                {
                    ...
                    b.Property<string>("gsmJsonArray")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PaperCalc.Models.GSM", b =>
                {
                    b.HasOne("PaperCalc.Models.Paper", null)
                        .WithMany("gsmArray")
